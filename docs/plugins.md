...
The main reason why flake8 is so popular is a powerful plugins' support. FlakeHeaven is fully compatible with all plugins. Let's talk about most important ones.
